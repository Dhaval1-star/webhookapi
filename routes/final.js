...
const headers = {
  'Authorization': 'Bearer EAAWhetaYelEBABNXqf4iRex1TrSt33MZApUF08YUUmJWimwEv9cWZCYW6Fo9ZAr3IiXbyiVcW7ZCBHb2H4tWovrdLKZCakZBHW4Q0YRWAFehI3Hs8eYtyn9Oiv0Jg8VA6vlNXr5nrZA5rBpJWtR605ZBxc0Bf2jrAHaBZBo4xXt0hFIu6w5zxxQmN',
...
// ----------------------------------------------------------------------------------
          ...
          var config223 = {
            ...
            headers: { 
              'Content-Type': 'application/json', 
              'Authorization': 'Bearer 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'
            },
            data : data12
          };
      ...
      if (incomingMessage.type === 'quick_reply_message') {
        ...
        if (data === "Check Our Bot Demo" && numberOfIssuesInCart === 1) {
          ...
          Whatsapp.sendRadioButtons({
            ...
            bodyText: ` Please select  Industry you are interested in? \n\n  Click below 👇 to view demo`,
            footerText: `© Wyaapar`,
            listOfSections,
            headers: `hello`,
          });
    ...
    //    ----------------------------------------
    var axios = require('axios');
    var datasendindsticker = JSON.stringify({
      "messaging_product": "whatsapp",
      "recipient_type": "individual",
      "to": recipientPhone,
      "type": "sticker",
